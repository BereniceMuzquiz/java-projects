...
public class StringSplitterInstance extends AbstractRuntimeComponentInstance {
    ...
    // *********** Berenice*********
    int propStartIndex = 0;  // separet de string in two parts, division begins in string number 20
    // ***********end  Berenice*********
    ...
    public Object getRuntimePropertyValue(String propertyName) {
        ...
        if ("Start Index".equalsIgnoreCase(propertyName)) {
    ...
    public Object setRuntimePropertyValue(String propertyName, Object newValue) {
        ...
        if ("Start Index".equalsIgnoreCase(propertyName)) {
            ...
            propStartIndex = Integer.parseInt(newValue.toString());
            return oldValue;
        }
    ...
    private final IRuntimeInputPort ipInput = new DefaultRuntimeInputPort() {
        ...
        public void receiveData(byte[] data) {
            ...
            String[] stringparts = line.split(propSeperator);
                ...
                for (int i = 0; ((i + propStartIndex) < stringparts.length) && (i < 16) ; i++) {
                    switch (i) {
                        case 0:
